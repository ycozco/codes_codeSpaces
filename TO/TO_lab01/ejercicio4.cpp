...
int main() {
    CitaMedica cita("2023-09-15 14:00", "Consulta General", "12345");
    cita.mostrarDetalles();
    cita.setFechaHora("2023-09-15 15:00");
    cita.setTipoAtencion("Examen de Rutina");
    cita.setNumeroAsegurado("123456");
    std::cout << "Cita Medica Modificada: "  << std::endl;
    cita.mostrarDetalles();
    return 0;
}
